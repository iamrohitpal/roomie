            ...
            <form action="{{ Auth::check() ? route('profile.update') : url('/profile-setup') }}" method="POST"
                ...
                <div style="display: flex; flex-direction: column; align-items: center; margin-bottom: 32px;">
                    <div id="avatar-preview"
                        style="width: 100px; height: 100px; border-radius: 50px; background: var(--glass-border); display: flex; align-items: center; justify-content: center; overflow: hidden; position: relative; cursor: pointer; border: 2px solid var(--primary-light);">
                ...
                <div style="margin-bottom: 24px;">
                    ...
                    <input type="text" name="name" placeholder="Enter your name"
                        ...
                        style="width: 100%; background: rgba(255, 255, 255, 0.05); border: 1px solid var(--glass-border); border-radius: 12px; padding: 14px; color: white; outline: none; font-size: 1rem;">
                </div>
